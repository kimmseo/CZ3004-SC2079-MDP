...
#define Motor_B_Encoder_Pin GPIO_PIN_6
#define Motor_B_Encoder_GPIO_Port GPIOA
#define Motor_B_EncoderA7_Pin GPIO_PIN_7
#define Motor_B_EncoderA7_GPIO_Port GPIOA
...
#define Motor_A_Encoder_Pin GPIO_PIN_15
#define Motor_A_Encoder_GPIO_Port GPIOA
#define Motor_A_EncoderB3_Pin GPIO_PIN_3
#define Motor_A_EncoderB3_GPIO_Port GPIOB
#define GYRO_Pin GPIO_PIN_8
#define GYRO_GPIO_Port GPIOB
#define GYROB9_Pin GPIO_PIN_9
#define GYROB9_GPIO_Port GPIOB
