...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(GYRO_GPIO_Port, GYRO_Pin);

    HAL_GPIO_DeInit(GYROB9_GPIO_Port, GYROB9_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(Motor_A_Encoder_GPIO_Port, Motor_A_Encoder_Pin);

    HAL_GPIO_DeInit(Motor_A_EncoderB3_GPIO_Port, Motor_A_EncoderB3_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Motor_B_Encoder_Pin|Motor_B_EncoderA7_Pin);
